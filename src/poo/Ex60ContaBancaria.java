...
public class Ex60ContaBancaria {
    ...
    public Ex60ContaBancaria() {
        this.extrato = new ArrayList<>();
        this.limite = 75.0;
        this.agencia = "4422";
    }
   
    public Ex60ContaBancaria(String agencia, String numero) {
        this.agencia = agencia;
        this.numero = numero;
        this.saldo = 0;
    }
    ...
    public void Transferir(double valorTransf, Ex60Cliente destinatario, Ex60Cliente origem) {
